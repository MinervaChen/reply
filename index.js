 ...
 * @param {string} callback - function to be activated after method is completed
 */
...
/**
 * Gets and processes reply/answers to error check and deliver appropriate response
 * @param {object} options - options object
 * @param {string} callback - function to be activated after event
 */
